...
DATA_DIR = Path("data/unique_distance_matrices")
RESULTS_DIR = Path("results")
TREES_DIR = RESULTS_DIR / "trees"

QUICKTREE = Path("quicktree-2.5/quicktree-2.5/quicktree")
RAPIDNJ = Path("rapidNJ/rapidNJ-master/bin/rapidnj")
OUR_NJ_SCRIPT = Path("src/run_nj.py")
